  ...
  return (
    <Section>
      ...
      <div css={iconBoxStyle}>
        <a href="https://github.com/dygreen" target="_blank" title={'깃허브 바로가기'}>
          <Icon icon="mdi:github" />
        </a>
        <a href="https://dygreen.tistory.com/" target="_blank" title={'티스토리 블로그 바로가기'}>
          <Icon icon="simple-icons:tistory" />
        </a>
        <a href="https://dygreen.notion.site/dygreen/9bb9bb6e91e74387b4985de6d8b74c8d" target="_blank" title={'노션 바로가기'}>
